...
<div id="dlg" align="center" style="height: 470px; padding-top: 50px">
	<form id="fm" method="post">
		...
		<input type='hidden' name='cusId' id="cusId" value='${personal.id }' />
		...
		<table border="0">
			...
			<tr>
				...
				<td><input onkeydown="isEmpty()" class="easyui" id="price"
						   name="price" ></input>
			...
			<tr id="ci">
				...
				<td><input id="number" class="easyui"
						   name="number"></input>
					<span id="numbers" style="color: red;"></span></td>
			</tr>
			...
			<tr id="tian">
				...
				<td><input id="days" class="easyui"
						   name="days"></input>
					<span id="dayss" style="color: red;"></span></td>
			</tr>
			<tr id="chu">
			...
			<tr id="ipa">
				...
				<td><textarea onkeydown="isEmpty()" style="margin: 0px; width: 419px; height: 146px;" class="form-control" rows="5"  name="eValue" id="ip" placeholder="提示：IP与IP之间以';'相隔 例127.0.0.1;127.0.0.2"></textarea>
				</td>
			</tr>
			<tr>
				<td></td>
...
<script type="text/javascript">
	...
	$.extend($.fn.validatebox.defaults.rules, {
		checkStartdate : {
			validator : function(value, param) {
				...
				if (ed < sd) {
					alert('结束日期小于开始日期');
					$('#edit_endTime').datebox('setValue', '').datebox(
							'showPanel');
				}
			},
	...
	function isEmpty(){
		...
		document.getElementById("bEFValue0s").innerHTML= "" ;
		document.getElementById("bEFValue1s").innerHTML= "" ;
	}
