...
<body class="easyui-layout">
	<div data-options="region:'center'"
		...
		<table id="custom_list"url="<%=path%>/personal/user/query.do" class="easyui-datagrid" style="width:auto;"  data-options="iconCls: 'icon-tip',rownumbers:true,toolbar: '#toolbar',
		...
		<!-- singleSelect: true,  单选 -->
			...
			<thead>
				<tr>
					...
					<th data-options="field:'customerName',width:100">用户名称/企业名称</th>
					<!-- <th
						data-options="field:'dateTime',width:100,formatter:dateFormatter">发布日期</th> -->
					
					<th data-options="field:'mobile',width:100">用户移动电话/企业固定电话</th>
					<th data-options="field:'email',width:100">用户邮箱地址/企业邮箱</th>
					<th data-options="field:'idCard',width:100">用户身份证号/法人身份证号</th>
					<th data-options="field:'address',width:100">用户地址/企业地址</th>
					<th data-options="field:'postcode',width:100">邮政编码</th>
					<th data-options="field:'bkey',width:100">数据来源（key）</th>
					<th data-options="field:'status',width:100,formatter:strutsFormatter">实名认证状态/企业认证状态</th>
					<th data-options="field:'approvalFrom',width:100,formatter:approvalFormatter">认证来源</th>
				</tr>
			</thead>
		</table>
	</div>
...
<script type="text/javascript">
	...
	$(function(){
		// 树
		 $('#custom_list').datagrid({
			url:'<%=path%>/personal/user/query.do',
	...
	var approvalFormatter = function(value, row, index) {
		if (value == 1) {
			return "芝麻认证";
		} else if(value == 2){
			return "银行认证";
