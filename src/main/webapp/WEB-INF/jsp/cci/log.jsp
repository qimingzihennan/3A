		...
		<div id="toolbar" style="padding: 5px; height: auto">
			<div style="margin-bottom: 5px">
				<span>业务模块名称:</span><input type="text" id="searchBusinessName"
					class="easyui-textbox" name="businessName" value="" size=10 /> <span>客户帐号:</span><input
					type="text" id="searchcName" class="easyui-textbox" name="customerName"
					value="" size=10 /> <a href="#" class="easyui-linkbutton"
					onclick="searchFunc()" iconCls="icon-search">查询</a>

			</div>
		</div>
		<table id="consumelog_list" url="<%=path%>/consume/log/person/query.do"
		...
		pagination:'true',fit:true,fitColumns:true,striped:true,nowrap:false">
			<thead>
				<tr>
					...
					<th data-options="field:'customerName',width:100">用户账号</th>
					<th
